# Cloud Hosts
Located at `services/cloud_hosts/`, this directory contains playbooks to create/destroy cloud hosts on DigitalOcean.


## Configuration
The configuration for the cloud hosts is stored in the [droplet.yaml](../../services/cloud_hosts/vars/droplet.yaml) file.
