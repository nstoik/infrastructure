...
- `wrapperr`: This service sets up a Spotify Wrapped style dashboard for Plex Media Server using
...
- On first setup, set the Admin username and password (*Arr useername and password stored in Bitwarden).
